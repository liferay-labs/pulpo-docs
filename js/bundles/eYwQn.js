...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eYwQn", function() { return eYwQn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace eYwQn.
 * @public
 */

goog.module('eYwQn.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param225 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul');
        ie_open('li');
          itext('Mandatory params: ');
          ie_open('code');
            itext('{parameterName}');
          ie_close('code');
          itext(' e.g. The {projectId} item must be replaced with the projectId of the current project.');
        ie_close('li');
        ie_open('li');
          itext('Optional params: ');
          ie_open('code');
            itext('{?parameterName}');
          ie_close('code');
          itext(' e.g. The {?filter} item must be replaced with a valid oData filter or with an empty string.');
        ie_close('li');
      ie_close('ul');
      ie_open('p');
        itext('Important: Optional parameters can be added at any time to these APIs, therefore, clients must consider that the templates may change with additional optional parameter names (never with mandatory parameter names).');
      ie_close('p');
      ie_open('p');
    ...
    ie_open('article', null, null,
      ...
      ie_close('p');
      ie_open('p');
        itext('In order to filter a collection based on the value of one or more fields, you can use the optional parameter filter following a subste of the oData standard.');
      ie_close('p');
      ie_open('h4');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'eYwQn.render';
}
...
class eYwQn extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(eYwQn, templates);
...
var eYwQn = function (_Component) {
  _inherits(eYwQn, _Component);

  function eYwQn() {
    _classCallCheck(this, eYwQn);

    return _possibleConstructorReturn(this, (eYwQn.__proto__ || Object.getPrototypeOf(eYwQn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eYwQn, _indexSoy2.default);

exports.default = eYwQn;
